          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            ...
            <div className="space-y-8">
              <div>
                ...
                {/* Added for Google reviewer clarity */}
                <p className="text-sm text-muted-foreground max-w-xl leading-6">
                  Virality Media is a marketing analytics platform that connects
                  user-authorized accounts from Google Ads, Meta Ads, and
                  Shopify to generate dashboards, campaign reports, performance
                  summaries, and AI-assisted insights. We access only the data
                  needed to provide these features to the user.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Monitor ROAS, CPA, revenue trends, and campaign efficiency
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
          <Card className="w-full max-w-md bg-card/50 border-border/50 backdrop-blur-xl shadow-2xl">
            <CardHeader className="space-y-1 text-center">
              ...
              {/* Added for mobile/homepage clarity */}
              <p className="text-xs text-muted-foreground pt-2 leading-5">
                Virality Media connects Google Ads, Meta Ads, and Shopify to
                help users view campaign performance, reports, and insights in
                one dashboard.
              </p>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSignUp} className="space-y-6">
                ...
                {/* Added: visible homepage links required for review */}
                <div className="pt-4 border-t border-border/50">
                  <div className="flex items-center justify-center gap-4 flex-wrap text-sm">
                    ...
                    <a
                      href="mailto:swaraj@viralitymedia.in"
                      className="text-primary hover:text-primary/80 underline underline-offset-4"
                    >
                      Contact
                    </a>
