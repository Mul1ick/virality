...
//               <input type="text" id="name" name="name" value={formData.name} onChange={handleInputChange} className="w-full px-4 py-3 ... " placeholder="Alex Johnson" required />
//             </div>
//             {/* Email Input */}
//             <div>
//               <label
...
function SignUp() {
  ...
  // This function now handles both name and email inputs
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setFormData({ ...formData, [e.target.name]: e.target.value });
    setError("");
  };
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    // Validate using the formData object
